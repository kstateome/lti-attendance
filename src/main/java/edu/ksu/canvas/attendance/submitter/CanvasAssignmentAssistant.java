...
public class CanvasAssignmentAssistant {
    ...
    private static final String ASSIGNMENT_DESCRIPTION ="This assignment is based on attendance recorded in the K-State" +
                                                        " Attendance tool. Do not make changes to attendance here; changes need to be made using the K-State Attendance" +
                                                        " tool. Information about the number of classes in which a student was present, tardy, absent, and excused" +
                                                        " is identified in the comments area of the student's grade.";
