...
<ol>
    ...
    <li>Enter "<spring:message code="institution.name" />  Attendance" in the Name field</li>
    ...
    <li>Navigate to your institution account page. There should now be a "<spring:message code="institution.name"/>  Attendance" link in the account navigation bar on the left.</li>
</ol>
...
&lt;cartridge_basiclti_link xmlns="http://www.imsglobal.org/xsd/imslticc_v1p0"
    ...
    &lt;blti:title&gt;<spring:message code="institution.name"/>  Attendance&lt;/blti:title&gt;
    &lt;blti:description&gt;<spring:message code="institution.name"/>  Attendance&lt;/blti:description&gt;
