        ...
        <table class="table table-bordered">
            ...
            <c:forEach items="${makeupForm.entries}" var="makeup" varStatus="makeupLoop">
                <tr id="row-${makeupLoop.index}">
                    <td>
                        ...
                        <div class="form-group">
                            <div class="input-group date">
                                <form:input id="classDate${makeupLoop.index}"
                                            path="entries[${makeupLoop.index}].dateOfClass"
                                            cssClass="form-control dateOfClass"/>
                    ...
                    <td>
                        <div class="form-group">
                            <div class="input-group date" id="datePickerMadeup-${makeupLoop.index}">
                                <form:input id="dateMadeUp${makeupLoop.index}"
                                            path="entries[${makeupLoop.index}].dateMadeUp"
                                            cssClass="form-control dateMadeUp"/>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                            </div>
                    ...
                    <td>
                        <form:input id="minutesMadeUp${makeupLoop.index}" path="entries[${makeupLoop.index}].minutesMadeUp"
                                    cssClass="form-control minutesMadeUp" size="5"/>
                        <form:errors cssClass="error center-block" path="entries[${makeupLoop.index}].minutesMadeUp"/>
                    </td>
                    <td>
                        <form:input path="entries[${makeupLoop.index}].projectDescription"
                                    cssClass="form-control projectDescription" size="5"/>
