                                    ...
                                    <c:when test="${rosterForm.simpleAttendance}">
                                        <c:choose>
                                            <c:when test="${attendance.status == 'TARDY' || attendance.status == 'ABSENT'}">
                                                <form:input id="notes${attendance.aviationStudentId}" cssClass="form-control" path="sectionModels[${sectionLoop.index}].attendances[${attendanceLoop.index}].notes"/>
                                            </c:when>
                                            <c:otherwise>
                                                <form:input id="notes${attendance.aviationStudentId}" cssClass="form-control" disabled="true" path="sectionModels[${sectionLoop.index}].attendances[${attendanceLoop.index}].notes"/>
                                            </c:otherwise>
                                        </c:choose>
                                    </c:when>
                                    <c:otherwise>
