...
[https://localhost:10443/kstateAttendance/](https://localhost:10443/kstateAttendance/) (port subject to change if you are running multiple VMs)
...
- Dev: https://localhost:10443/kstateAttendance
- LTI Test 1: https://lti.test.canvas.k-state.edu/kstateAttendance
- Production: https://lti.canvas.k-state.edu/kstateAttendance
